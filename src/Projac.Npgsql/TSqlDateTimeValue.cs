...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlDateTimeValue : IDbParameterValue
    {
        private readonly DateTime _value;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlDateTimeValue" /> class.
        /// </summary>
        /// <param name="value">The value.</param>
        public NpgsqlDateTimeValue(DateTime value)
        {
            _value = value;
        }
        ...
        private bool Equals(NpgsqlDateTimeValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlDateTimeValue) obj);
        }
