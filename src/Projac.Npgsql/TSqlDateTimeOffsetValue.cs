...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlDateTimeOffsetValue : IDbParameterValue
    {
        private readonly DateTimeOffset _value;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlDateTimeOffsetValue" /> class.
        /// </summary>
        /// <param name="value">The value.</param>
        public NpgsqlDateTimeOffsetValue(DateTimeOffset value)
        {
            _value = value;
        }
        ...
        private bool Equals(NpgsqlDateTimeOffsetValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlDateTimeOffsetValue) obj);
        }
