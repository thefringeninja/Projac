...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlDecimalNullValue : IDbParameterValue
    {
        private readonly NpgsqlDecimalScale _scale;
        private readonly NpgsqlDecimalPrecision _precision;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlDecimalNullValue" /> class.
        /// </summary>
        ...
        public NpgsqlDecimalNullValue(NpgsqlDecimalPrecision precision, NpgsqlDecimalScale scale)
        {
            if (scale > precision)
            {
        ...
        private bool Equals(NpgsqlDecimalNullValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlDecimalNullValue)obj);
        }
