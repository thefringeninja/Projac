...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlVarBinaryValue : IDbParameterValue
    {
        private readonly int _size;
        private readonly byte[] _value;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlVarBinaryValue" /> class.
        /// </summary>
        /// <param name="value">The parameter value.</param>
        /// <param name="size">The parameter size.</param>
        /// <exception cref="System.ArgumentNullException">Thrown when the <paramref name="value" /> is <c>null</c>.</exception>
        public NpgsqlVarBinaryValue(byte[] value, NpgsqlVarBinarySize size)
        {
            if (value == null)
        ...
        private bool Equals(NpgsqlVarBinaryValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlVarBinaryValue) obj);
        }
