...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlVarCharNullValue : IDbParameterValue
    {
        private readonly NpgsqlVarCharSize _size;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlVarCharNullValue" /> class.
        /// </summary>
        /// <param name="size">The size.</param>
        public NpgsqlVarCharNullValue(NpgsqlVarCharSize size)
        {
            _size = size;
        }
        ...
        private bool Equals(NpgsqlVarCharNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((NpgsqlVarCharNullValue) obj);
        }
