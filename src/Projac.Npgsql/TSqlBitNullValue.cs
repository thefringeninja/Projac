...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlBitNullValue : IDbParameterValue
    {
        /// <summary>
        ///     The single instance of this value.
        /// </summary>
        public static readonly NpgsqlBitNullValue Instance = new NpgsqlBitNullValue();

        private NpgsqlBitNullValue()
        {
        }
        ...
        private static bool Equals(NpgsqlBitNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((NpgsqlBitNullValue) obj);
        }
