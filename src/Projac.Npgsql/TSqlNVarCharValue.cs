...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlNVarCharValue : IDbParameterValue
    {
        private readonly int _size;
        private readonly string _value;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlNVarCharValue" /> class.
        /// </summary>
        /// <param name="value">The parameter value.</param>
        /// <param name="size">The parameter size.</param>
        /// <exception cref="System.ArgumentNullException">Thrown when the <paramref name="value" /> is <c>null</c>.</exception>
        public NpgsqlNVarCharValue(string value, NpgsqlNVarCharSize size)
        {
            if (value == null)
        ...
        private bool Equals(NpgsqlNVarCharValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlNVarCharValue) obj);
        }
