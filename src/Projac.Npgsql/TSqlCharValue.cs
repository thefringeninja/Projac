...
{
    /// <summary>
    ///     Represents a T-SQL CHAR parameter value.
    /// </summary>
    public class NpgsqlCharValue : IDbParameterValue
    {
        private readonly int _size;
        private readonly string _value;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlCharValue" /> class.
        /// </summary>
        /// <param name="value">The parameter value.</param>
        /// <param name="size">The parameter size.</param>
        /// <exception cref="System.ArgumentNullException">Thrown when the <paramref name="value" /> is <c>null</c>.</exception>
        public NpgsqlCharValue(string value, NpgsqlCharSize size)
        {
            if (value == null)
        ...
        private bool Equals(NpgsqlCharValue other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((NpgsqlCharValue) obj);
        }
