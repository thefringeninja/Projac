...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlBinaryNullValue : IDbParameterValue
    {
        private readonly NpgsqlBinarySize _size;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlBinaryNullValue" /> class.
        /// </summary>
        /// <param name="size">The size.</param>
        public NpgsqlBinaryNullValue(NpgsqlBinarySize size)
        {
            _size = size;
        }
        ...
        private bool Equals(NpgsqlBinaryNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((NpgsqlBinaryNullValue) obj);
        }
