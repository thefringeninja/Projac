...
namespace Projac.Npgsql
{
    ...
    /// </summary>
    public class NpgsqlUniqueIdentifierNullValue : IDbParameterValue
    {
        /// <summary>
        ///     The single instance of this value.
        /// </summary>
        public static readonly NpgsqlUniqueIdentifierNullValue Instance = new NpgsqlUniqueIdentifierNullValue();

        private NpgsqlUniqueIdentifierNullValue()
        {
        }
        ...
        private static bool Equals(NpgsqlUniqueIdentifierNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((NpgsqlUniqueIdentifierNullValue) obj);
        }
