...
{
    /// <summary>
    ///     Represents the T-SQL NCHAR NULL parameter value.
    /// </summary>
    public class NpgsqlNCharNullValue : IDbParameterValue
    {
        private readonly NpgsqlNCharSize _size;

        /// <summary>
        ///     Initializes a new instance of the <see cref="NpgsqlNCharNullValue" /> class.
        /// </summary>
        /// <param name="size">The size.</param>
        public NpgsqlNCharNullValue(NpgsqlNCharSize size)
        {
            _size = size;
        }
        ...
        private bool Equals(NpgsqlNCharNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((NpgsqlNCharNullValue) obj);
        }
