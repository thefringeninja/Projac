...
{
    [TestFixture]
    public class NpgsqlDecimalValueTests
    {
        [Test]
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectNpgsqlParameter(parameterName, NpgsqlDbType.Money, 123.0m, false, 0, 19, 2);
        }
        ...
        public void ToSqlParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectNpgsqlParameter(parameterName, NpgsqlDbType.Money, 123, false, 0, 19, 2);
        }
        ...
        private static NpgsqlDecimalValue SutFactory()
        {
            return SutFactory(123.0m);
        }

        private static NpgsqlDecimalValue SutFactory(decimal value, byte precision = 18, byte scale = 0)
        {
            return new NpgsqlDecimalValue(value, precision, scale);
        }
    }
}