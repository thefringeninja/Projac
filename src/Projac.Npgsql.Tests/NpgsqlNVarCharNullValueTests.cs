...
{
    [TestFixture]
    public class NpgsqlNVarCharNullValueTests
    {
        private NpgsqlNVarCharNullValue _sut;
        private NpgsqlNVarCharSize _size;

        [SetUp]
        public void SetUp()
        {
            _size = new NpgsqlNVarCharSize(100);
            _sut = new NpgsqlNVarCharNullValue(_size);
        }
