...
{
    [TestFixture]
    public class NpgsqlBigIntValueTests
    {
        [Test]
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectNpgsqlParameter(parameterName, NpgsqlDbType.Bigint, 123, false, 8);
        }
        ...
        private static NpgsqlBigIntValue SutFactory()
        {
            return SutFactory(123);
        }

        private static NpgsqlBigIntValue SutFactory(long value)
        {
            return new NpgsqlBigIntValue(value);
        }
    }
}