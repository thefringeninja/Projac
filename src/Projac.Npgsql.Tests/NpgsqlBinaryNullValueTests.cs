...
{
    [TestFixture]
    public class NpgsqlBinaryNullValueTests
    {
        private NpgsqlBinaryNullValue _sut;
        private NpgsqlBinarySize _size;

        [SetUp]
        public void SetUp()
        {
            _size = new NpgsqlBinarySize(100);
            _sut = new NpgsqlBinaryNullValue(_size);
        }
