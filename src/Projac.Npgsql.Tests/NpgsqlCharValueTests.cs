...
{
    [TestFixture]
    public class NpgsqlCharValueTests
    {
        [Test]
        public void NullIsNotAnAcceptableValue()
        {
            Assert.Throws<ArgumentNullException>(() => SutFactory(null, new NpgsqlCharSize(123)));
        }
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            var sut = SutFactory(value, new NpgsqlCharSize(123));
        ...
        {
            var sut = SutFactory("value", new NpgsqlCharSize(123));
            var other = SutFactory("value", new NpgsqlCharSize(123));
        ...
        {
            var sut = SutFactory("value1", new NpgsqlCharSize(123));
            var other = SutFactory("value2", new NpgsqlCharSize(123));
        ...
        {
            var sut = SutFactory("value", new NpgsqlCharSize(123));
            var other = SutFactory("value", new NpgsqlCharSize(456));
            Assert.That(sut.Equals(other), Is.False);
        }
        ...
        private static NpgsqlCharValue SutFactory()
        {
            return SutFactory("value", new NpgsqlCharSize(123));
        }

        private static NpgsqlCharValue SutFactory(string value, NpgsqlCharSize size)
        {
