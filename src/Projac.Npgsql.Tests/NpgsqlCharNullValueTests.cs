...
{
    [TestFixture]
    public class NpgsqlCharNullValueTests
    {
        private NpgsqlCharNullValue _sut;
        private NpgsqlCharSize _size;

        [SetUp]
        public void SetUp()
        {
            _size = new NpgsqlCharSize(100);
            _sut = new NpgsqlCharNullValue(_size);
        }
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectNpgsqlParameter(parameterName, NpgsqlDbType.Char, DBNull.Value, true, 100);
        }
