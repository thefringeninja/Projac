...
{
    [TestFixture]
    public class NpgsqlDateTimeValueTests
    {
        [Test]
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectNpgsqlParameter(parameterName, NpgsqlDbType.Date, value, false, 8);
        }
        ...
        private static NpgsqlDateTimeValue SutFactory()
        {
            return SutFactory(DateTime.UtcNow);
        }

        private static NpgsqlDateTimeValue SutFactory(DateTime value)
        {
            return new NpgsqlDateTimeValue(value);
        }
    }
}